...
describe("Exchange", () => {
    ...
    it("is deployed", async () => {
        ...
        expect(await exchange.name()).to.equal("LP SWAP token");
        expect(await exchange.symbol()).to.equal("LP-SWAP");
    ...
    describe("addLiquidity", async () => {
        ...
        describe("existing reserves ratio 2:1", async () => {
            beforeEach(async () => {
    ...
    describe("removeLiquidity", async () => {
        ...
        it("removes some liquidity", async () => {
            ...
            // ).to.equal("24.99993540242959119"); // 25 - gas fees
