...
describe("Exchange", () => {
    beforeEach(async () => {
        ...
        token = await Token.deploy("CoinX", "XXX", toWei(1000000));
    ...
    describe("addLiquidity", async () => {
        it("adds liquidity 100 tokens", async () => {
        ...
        it("adds liquidity 200 tokens", async () => {
            await token.approve(exchange.address, toWei(200));
            await exchange.addLiquidity(toWei(200), { value: toWei(200) });
